    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form role="form" method="post" action="{{ route('backend.categories.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        @if ($errors->any())
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="depth" class="form-control" id="" placeholder="Điền do sau danh mục">
                            </div>
                </div>
                <!-- /.card-body -->
