								...
								<div class="owl-item deals_item">
									...
									<div class="deals_content">
										...
										<div class="deals_info_line d-flex flex-row justify-content-start">
											...
											<div class="deals_item_price ml-auto">{{number_format($product->sale_price)}} VND</div>
										</div>
										<div class="available">
										...
										<div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
											...
											<div class="product_content">
												...
												<div class="product_extras">
													...
													<a href="/online/cart/add/{{$product->id}}" class="product_cart_button btn btn-success">Add to Cart</a>
												</div>
											</div>
                                    ...
                                    <!-- Slider Item -->
                                        <div class="featured_slider_item">
                                            ...
                                            <div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
                                                ...
                                                <div class="product_content">
                                                    <div class="product_price discount">{{$product->sale_price}}<span>{{$product->origin_price}}</span></div>
								...
								<div class="featured_slider slider">
									...
									<div class="featured_slider_item">
										...
										<div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
											<div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="/frontend/images/featured_1.png" alt=""></div>
											<div class="product_content">
												<div class="product_price discount">{{number_format($product->sale_price)}} VND<span>{{number_format($product->origin_price)}}</span></div>
												<div class="product_name"><div><a href="product.html">{{$product->name}}</a></div></div>
												<div class="product_extras">
													<div class="product_color">
														<input type="radio" checked name="product_color" style="background:#b19c83">
									...
									<div class="arrivals_slider slider">
										...
										<div class="arrivals_slider_item">
											...
											<div class="product_item is_new d-flex flex-column align-items-center justify-content-center text-center">
												...
												<div class="product_content">
													<div class="product_price">{{number_format($product->origin_price)}} VND</div>
													<div class="product_name"><div><a href="product.html">{{$product->name}}</a></div></div>
													<div class="product_extras">
														<div class="product_color">
															<input type="radio" checked name="product_color" style="background:#b19c83">
...
{{--                                                @endforeach--}}
{{--                                            </div>--}}
											<div class="bestsellers_name"><a href="{{route('frontend.products.index')}}">{{$product->name}}</a></div>
											<div class="rating_r rating_r_4 bestsellers_rating"><i></i><i></i><i></i><i></i><i></i></div>
											<div class="bestsellers_price discount">{{number_format($product->sale_price)}} VND<span>{{number_format($product->origin_price)}} VND</span></div>
										</div>
									</div>
