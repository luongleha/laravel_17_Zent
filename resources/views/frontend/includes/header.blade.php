                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 col-sm-3 col-3 order-1">
                        <div class="logo_container">
                            <div class="logo"><a href="#"><a href="{{route('frontend.index')}}">OneTech</a></a></div>
                        </div>
                    </div>
                            ...
                            <div class="main_nav_menu ml-auto">
                                <ul class="standard_dropdown main_nav_dropdown">
                                    ...
                                    <li class="hassubs">
                                        ...
                                        <ul>
                                            <li><a href="{{route('frontend.shop.index')}}">Shop<i class="fas fa-chevron-down"></i></a></li>
                                            <li><a href="{{route('frontend.products.index')}}">Product<i class="fas fa-chevron-down"></i></a></li>
                                            <li><a href="blog.html">Blog<i class="fas fa-chevron-down"></i></a></li>
                                            <li><a href="blog_single.html">Blog Post<i class="fas fa-chevron-down"></i></a></li>
                                            <li><a href="regular.html">Regular Post<i class="fas fa-chevron-down"></i></a></li>
                                            <li><a href="{{route('frontend.cart.index')}}">Cart<i class="fas fa-chevron-down"></i></a></li>
                                            <li><a href="{{route('frontend.contact.index')}}">Contact<i class="fas fa-chevron-down"></i></a></li>
                                        </ul>
                                    </li>
                                    <li><a href="blog.html">Blog<i class="fas fa-chevron-down"></i></a></li>
