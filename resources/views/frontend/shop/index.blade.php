...
{{--                                </div>--}}
{{--                                <div class="product_content">--}}
{{--                                    <div class="product_price">{{$product->sale_price}}<span>{{$product->origin_price}}</span></div>--}}
{{--                                    <div class="product_name"><div><a href="#" tabindex="0">{{$product->name}}</a></div></div>--}}
{{--                                </div>--}}
{{--                                <div class="product_fav"><i class="fas fa-heart"></i></div>--}}
{{--                                <ul class="product_marks">--}}
                            ...
                            <div class="owl-item">
                                <div class="viewed_item discount d-flex flex-column align-items-center justify-content-center text-center">
                                    ...
                                    <div class="viewed_content text-center">
                                        <div class="viewed_price">{{number_format($product->sale_price)}} VND<span>{{number_format($product->origin_price)}} VND</span></div>
